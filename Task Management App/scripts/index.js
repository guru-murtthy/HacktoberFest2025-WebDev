        ...
        <div class='card-body'>
          ${
            url
              ...
              : `
        <img width='100%' height='250px' src="https://images.unsplash.com/photo-1695897706183-5295269554b9?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZGFpc3klMjBmbG93ZXJ8ZW58MHx8MHx8fDA%3D&fm=jpg&q=60&w=3000" alt='card image cap' class='card-image-top md-3 rounded-lg' />
        `
          }
...
const htmlModalContent = ({ id, title, description, url }) => {
  ...
  return `
      ...
      ${
        ...
        `
          : `
        <img width='100%' src="https://images.unsplash.com/photo-1695897706183-5295269554b9?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZGFpc3klMjBmbG93ZXJ8ZW58MHx8MHx8fDA%3D&fm=jpg&q=60&w=3000" alt='card image cap' class='img-fluid place__holder__image mb-3' />
        `
      }
